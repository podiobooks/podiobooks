...
dojo.declare("pbwidgets.book_shelf.BookShelfFade",
	pbwidgets.book_shelf.BookShelf,
	{
...
dojo.declare("pbwidgets.book_shelf.BookShelfSlide",
	pbwidgets.book_shelf.BookShelf,
	{
	...
	_hideChild: function(page){
		...
		page.selected = false;
		dojo.style(page.domNode,{
			zIndex: this.zTop - 1, display: "none" 
		});
		if(page.onHide){
			page.onHide();
		}
