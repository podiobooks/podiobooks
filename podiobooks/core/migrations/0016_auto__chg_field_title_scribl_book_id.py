...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Title.scribl_book_id'
        db.alter_column(u'core_title', 'scribl_book_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Title.scribl_book_id'
        db.alter_column(u'core_title', 'scribl_book_id', self.gf('django.db.models.fields.IntegerField')(null=True))
