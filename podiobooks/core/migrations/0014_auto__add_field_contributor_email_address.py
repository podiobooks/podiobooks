...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contributor.email_address'
        db.add_column(u'core_contributor', 'email_address',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contributor.email_address'
        db.delete_column(u'core_contributor', 'email_address')
