...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Episode', fields ['deleted']
        db.create_index('core_episode', ['deleted'])

        # Adding index on 'Title', fields ['deleted']
        db.create_index('core_title', ['deleted'])


    def backwards(self, orm):
        # Removing index on 'Title', fields ['deleted']
        db.delete_index('core_title', ['deleted'])

        # Removing index on 'Episode', fields ['deleted']
        db.delete_index('core_episode', ['deleted'])
