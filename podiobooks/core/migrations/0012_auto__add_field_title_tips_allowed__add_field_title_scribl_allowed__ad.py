...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Title.tips_allowed'
        db.add_column('core_title', 'tips_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Title.scribl_allowed'
        db.add_column('core_title', 'scribl_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Title.date_accepted'
        db.add_column('core_title', 'date_accepted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Title.tips_allowed'
        db.delete_column('core_title', 'tips_allowed')

        # Deleting field 'Title.scribl_allowed'
        db.delete_column('core_title', 'scribl_allowed')

        # Deleting field 'Title.date_accepted'
        db.delete_column('core_title', 'date_accepted')
