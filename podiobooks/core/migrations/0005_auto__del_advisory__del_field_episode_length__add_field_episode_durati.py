...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Episode.length'
        db.delete_column('core_episode', 'length')

        # Adding field 'Episode.duration'
        db.add_column('core_episode', 'duration',
                      self.gf('django.db.models.fields.CharField')(default='45:00', max_length=20),
                      keep_default=False)

        # Deleting field 'Title.advisory'
        db.delete_column('core_title', 'advisory_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Episode.length'
        db.add_column('core_episode', 'length',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'Episode.duration'
        db.delete_column('core_episode', 'duration')

        # Adding field 'Title.advisory'
        db.add_column('core_title', 'advisory',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='titles', null=True, to=orm['core.Advisory'], blank=True),
                      keep_default=False)
