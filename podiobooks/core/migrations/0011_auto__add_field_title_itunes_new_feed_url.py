...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Title.itunes_new_feed_url'
        db.add_column('core_title', 'itunes_new_feed_url',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Title.itunes_new_feed_url'
        db.delete_column('core_title', 'itunes_new_feed_url')
