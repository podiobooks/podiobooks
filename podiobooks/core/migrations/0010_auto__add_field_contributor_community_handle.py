...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contributor.community_handle'
        db.add_column('core_contributor', 'community_handle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contributor.community_handle'
        db.delete_column('core_contributor', 'community_handle')
