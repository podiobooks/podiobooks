...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Title.assets_from_images'
        db.add_column(u'core_title', 'assets_from_images',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Title.assets_from_images'
        db.delete_column(u'core_title', 'assets_from_images')
