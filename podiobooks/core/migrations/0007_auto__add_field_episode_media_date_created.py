...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.media_date_created'
        db.add_column('core_episode', 'media_date_created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.media_date_created'
        db.delete_column('core_episode', 'media_date_created')
