...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Title.is_family_friendly'
        db.add_column('core_title', 'is_family_friendly',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Title.is_for_kids'
        db.add_column('core_title', 'is_for_kids',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Title.is_family_friendly'
        db.delete_column('core_title', 'is_family_friendly')

        # Deleting field 'Title.is_for_kids'
        db.delete_column('core_title', 'is_for_kids')
