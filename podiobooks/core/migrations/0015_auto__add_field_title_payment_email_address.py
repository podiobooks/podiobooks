...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Title.payment_email_address'
        db.add_column(u'core_title', 'payment_email_address',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Title.payment_email_address'
        db.delete_column(u'core_title', 'payment_email_address')
