...
urlpatterns = patterns('',
    ...
    url(r'^title/category/shelf/(?P<category_slug>[^/]+)/$', 'podiobooks.core.views.title_list_by_category', {'template_name': 'main/shelf/category_shelf.html'}, name='title_category_shelf'),
    url(r'^title/contributor/shelf/(?P<contributor_slug>[^/]+)/$', 'podiobooks.core.views.title_list_by_contributor', {'template_name': 'main/shelf/contributor_shelf.html'}, name='title_contributor_shelf'),
