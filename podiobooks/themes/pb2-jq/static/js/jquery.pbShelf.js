...
(function ($) {
    ...
    $.fn.pbShelf = function (options) {
        ...
        return this.each(function () {
             ...
             */
            var start = 0;			// How many "titles in" the user is (integer, 0-# of books)
            ...
            var shelfViewBoundaries = [
                ...
                0,
                0
            ]; // [[<offset left>, <offset top>], <shelf width>, <shelf height>]
            ...
            if (shelf.has("form select")) {
                ...
                sel.change(function () {
                    settings.url = sel.parents("form").attr("action") + sel.val() + '/';
                    settings.clearShelfFirst = true;
                    shelf.pbShelf(settings);
                });
            }
                ...
                if (wholeShelf && $("html").hasClass("touch")) {
                    ...
                    document.addEventListener('touchmove', function (event) {
                        ...
                        if (movingThisShelf) {
                            ...
                            // If we haven't yet decided whether we are sliding a shelf or scrolling,
            ...
            var handleShelfPosition = function () {
                ...
                if (shelf.find(settings.shelfItem).length) {
                    ...
                    loadImages();
                    drawShelfBoundaries();
                    settings.afterMoveEnd((Math.round(start) + perSlide), perSlide);
                }
            };
