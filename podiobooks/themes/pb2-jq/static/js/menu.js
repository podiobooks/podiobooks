$(function(){
	...
	$("<ul><li><a href='" + siteVars("home") + "'>Podiobooks Home</a></li></ul>").prependTo(menu);
	var triggers = $("<ul class='menu-triggers' />").insertAfter(".nav-bar .search");
	var menuTrigger = $("<li><a href='" + siteVars('home') + "' class='menu-trigger' id='site-menu-trigger'><img src='" + siteVars("img") + "pb-logo-icon.png' /></a></li>").appendTo(triggers);
	/*
