...
urlpatterns = patterns('',
    ...
    url(r'^title/search/$','pbsite.main.views.title_search', name='title_search_form'),
    url(r'^title/search/(?P<keywords>[^/]+)/$','pbsite.main.views.title_search', name='title_search'),
    url(r'^title/search/redirect$','pbsite.main.views.title_search', name='title_search_redirect'),
